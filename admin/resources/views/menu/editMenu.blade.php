            ...
            <div class="card" style="margin-left: 10px; border-radius: 10px;">
                ...
                <div class="card-body" style="padding: 1%;">
                    <div align="center" style="margin-bottom: 3%;">
                        <h2 style="color: #989898;"><b>Edit Menu Information</b></h2>
                    </div>

                    <form name="addProductForm" class="form-horizontal" method="post" action="{{route('menu.update',['id'=>$menu->menuId])}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input  maxlength="255" placeholder="255 characters maximum" id="inputHorizontalSuccess" type="text" value="{{ $menu->menuName }}" name="menuName"  class="form-control form-control-success" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select name="parentId" class="form-control form-control-warning select">
                                    ...
                                    <option @if($menu->menuId==$aM->menuId )selected @endif value="{{$aM->menuId}}">{{$aM->menuName}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input id="inputHorizontalWarning" type="text"  maxlength="11" onkeypress="return isNumberKey(event)" placeholder="11 characters maximum" value="{{ $menu->orderNumber }}" name="orderNumber"  class="form-control form-control-warning" required>
                            ...
                            <div class="col-sm-10">
                                <select name="postId" class="form-control form-control-warning select">
                                    ...
                                    @foreach($allPost as $aP)
                                        <option @if($menu->postId == $aP->postId )selected @endif value="{{$aP->postId}}">{{$aP->header}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select name="menuStatus" class="form-control form-control-warning" required>
                                    ...
                                    <option @if($menu->menuStatus== Status[$i]) selected @endif value="<?php echo Status[$i]?>"><?php echo Status[$i]?></option>
                                    <?php }}?>
                                </select>
                            </div>
                        </div>
