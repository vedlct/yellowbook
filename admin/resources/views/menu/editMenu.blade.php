        ...
        <div class="col-lg-12">
            <div class="card" style="margin-left: 10px; border-radius: 10px;">
                ...
                <div class="card-body" style="padding: 1%;">
                    ...
                    <form name="addProductForm" class="form-horizontal" method="post" action="{{route('menu.update')}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input id="inputHorizontalWarning" type="text"  maxlength="20" onkeypress="return isNumberKey(event)" placeholder="20 characters maximum" value="{{ $menu->orderNumber }}" name="orderNumber"  class="form-control form-control-warning" required>
