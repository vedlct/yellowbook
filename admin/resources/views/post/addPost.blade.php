            ...
            <div class="card" style="margin-left: 10px; border-radius: 10px;">
                ...
                <div class="card-body" style="padding: 1%;">
                    <div align="center" style="margin-bottom: 3%;">
                        <h2 style="color: #989898;"><b>Add Post Information</b></h2>
                    </div>

                    <form name="addProductForm" class="form-horizontal" method="post" action="{{route('post.insert')}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input  maxlength="255" placeholder="255 characters maximum" id="inputHorizontalSuccess" type="text" value="{{ old('header') }}" name="header"  class="form-control form-control-success" required>
                            ...
                            <div class="col-sm-10">
                                <select name="fkcategoryId" class="form-control form-control-warning select">
                                    ...
                                    @foreach($allCategory as $aC)
                                        <option @if(old('fkcategoryId')==$aC->categoryId )selected @endif value="{{$aC->categoryId}}">{{$aC->categoryName}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-10">
                                <select name="fkcompanyId" class="form-control form-control-warning select">
                                    ...
                                    @foreach($allCompany as $aCom)
                                        <option @if(old('fkcompanyId')==$aCom->companyId )selected @endif value="{{$aCom->companyId}}">{{$aCom->companyName}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-10">
                                <select name="fkmenuId" class="form-control form-control-warning select">
                                    ...
                                    @foreach($allMenu as $aM)
                                        <option @if(old('fkmenuId')==$aM->menuId )selected @endif value="{{$aM->menuId}}">{{$aM->menuName}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control ckeditor" name="body" rows="6" >{{ old('body') }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select name="postStatus" class="form-control form-control-warning" required>
                                    ...
                                    <option @if(old('postStatus')==Status[$i] )selected @endif  value="<?php echo Status[$i]?>"><?php echo Status[$i]?></option>
                                    <?php }}?>
                                </select>
                            </div>
                        </div>
