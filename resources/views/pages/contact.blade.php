...
<div class="margin-bottom-10 padding-top-bottom-10 bg-skyblue"> <!--matri #ff6666   tuition #D8D8FA  Bangladesh  #009900   travel #ffcccc  biz #cccccc  yp  #FFBA53-->
    <div class="container">
        ...
        <div class="col-md-10 col-sm-9 padding-top-6">
            ...
            General
            <span class="text-small">></span>
            Contact information & numbers of bdtradeinfo.com & T-Series Solutions                </div>
                    ...
                    <div class="col-md-12 col-xs-12 div_style3">
                        ...
                        <div class="main_content2">
                            <div class="col-md-6 col-sm-6 col-xs-12 margin-top-bottom-10 padding-bottom-5 text-left">
                                <h2>bdtradeinfo.com</h2><br/>
                                <h4>T-Series Solutions</h4><br/>
                                Rose View Plaza (7th Floor, Room-808)<br/>
                                185 Elephant Road, Hatirpool, Dhaka-1205, Bangladesh<br/><br/>
                                <span class="oswald_black1">Telephone:</span> +88-02-9676369, 9667598
                                <br/><br/>
                                <span class="oswald_black1">E-mail:</span> <a href="mailto:info@bdtradeinfo.com" class="navtxt1">info@bdtradeinfo.com</a>, <a href="mailto:bdtradeinfo@gmail.com" class="navtxt1">bdtradeinfo@gmail.com</a>
                                <br/><br/>
                                <span class="oswald_black1">Mobile:</span>(+88) 01794-138869<br/>
                                [<span class="mega_title_blue">Asim Tarafder, CEO, bdtradeinfo.com & T-Series Solutions</span>]
                                <!--                                        <br/><br/>
                                                                        <span class="orange_bold">T-Series Solutions</span><br/><span class="orange_bold">bdtradeinfo.com</span> ]<br/>-->
                                <br/><br/>
                                <span class="oswald_black1">Web site: </span><a href="../index-2.html" class="navtxt1">www.bdtradeinfo.com</a>
                                <br/><br/>
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-12 margin-top-bottom-10 padding-bottom-5">
                                <iframe width="100%" height="186" src="https://www.youtube.com/embed/ya4tUKZXjGY?autoplay=1" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                            </div>

                            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d14608.822974789546!2d90.3913063!3d23.7400415!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x235faee1b3b38aa0!2sT-Series+Solutions+(bdtradeinfo.com)!5e0!3m2!1sen!2s!4v1496645696857" height="320" class="border-0 width-100" allowfullscreen></iframe>

                            <p>&nbsp;</p>
                            <div class="col-md-6">
                                <p><span class="orange_bold">USA OFFICE</span></p>
                                <p><span class="sub_ttl"><strong>E2000ERA LLC, USA</strong></span><br/>
                                    1738 CROW CREEK AVE<br/>
                                    LAS VEGAS NV 8912, USA <br/>
                                    <br/>
                                    <strong>Telephone: </strong>+1-7029875085
                                </p>
                                <p><strong>E-mail: </strong><a href="mailto:e2000era@gmail.com" class="navtxt1">e2000era@gmail.com</a><br/>
                                    <!-- <strong>Web site:</strong> <a href="http://www.e2000era.com" class="navtxt1">www.e2000era.com</a> -->
                                </p>
                                <p>&nbsp;</p>
                            </div>

                            <div class="col-md-6">
                                <img src="../images/contact_us.png" alt="contact us" title="contact us" class="img-responsive">
                            </div>
