...
<div class="margin-bottom-10 padding-top-bottom-10 bg-skyblue"> <!--matri #ff6666   tuition #D8D8FA  Bangladesh  #009900   travel #ffcccc  biz #cccccc  yp  #FFBA53-->
    <div class="container">
        ...
        <div class="col-md-10 col-sm-9 padding-top-6">
            ...
            General
            <span class="text-small">></span>
            <a href='services.html'>Services</a> > Advertise with us                </div>
                        ...
                        <div class="main_content2">
                            ...
                            <div class="col-md-6 col-xs-12 margin-top-10">
                                <table class="table-striped table-bordered">
                                    <tr>
                                        <td colspan="3" class="text-center"><span class="oswald_black">Upper Banner</span></td>
                                    </tr>
                                    <tr>
                                        <td colspan="3" class="text-center">
                                            <div class="oswald_meroon1">Ad Size : W-480 x H-60 pixel / W-169 x H-21 mm</div>
                                        </td>
                                    </tr>
                                    <tr>
                            ...
                            <div class="col-md-6 col-xs-12 margin-top-10">
                                <table class="table-striped table-bordered">
                                    <tr>
                                        <td colspan="3" class="text-center"><span class="oswald_black">Classic Banner</span></td>
                                    </tr>
                                    <tr>
                                        <td colspan="3" class="text-center">
